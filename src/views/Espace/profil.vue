    ...
    <div class="container-general">
          ...
          <div class="profile-pic">
                ...
                <img  v-else :src="image" id="output" width="200" />
                    ...
                    <div class="col-md-8 d-flex align-items-center py-5">
                            ...
                            <div class="row">
                                <div class="col-11 col-lg-11 mx-auto">
                                    ...
                                    <form data-request="onSignin" class="login_form">
                                        ...
                                        <button class="hover-btn" @click.prevent="HamdlePassword"> Soumettre</button>
                                    </div>
                                    </form>
...
async HamdleSign(){
  ...
  if (this.password.trim() === '' || this.password.length < 8) {
       this.errorPassword = 'Le mot de passe doit contenir au moins 8 caractères.';
      } else {
          this.loading = true
     ...
     try {
        ...
        console.log(response);
         ...
         console.error('errorzzzz',error.response);
         if (error.response.data.message==="Vous n'êtes pas autorisé." || error.response.status === 401) {
            await this.$store.dispatch('user/clearLoggedInUser');
              this.$router.push("/connexion");  //a revoir
            }
