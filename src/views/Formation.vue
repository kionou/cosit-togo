        						...
        						<div class="s2-pricing_item card">
        							<div class="s2-pricing_price relative-position clearfix">
										...
										<div class="image" style="height: 100%; width: 100%;">
											<img src="../assets/site/img1.jpg" alt="" style="height: 100%; object-fit: cover;filter: brightness(75%); border-radius: 6px 6px 0 0; border-radius: 6px 6px 0 0;">
										</div>
        								<div class="s2-pricing_text">
        									<span>Basic</span>
        									<strong>80 000 F CFA</strong>
        								</div>
        							...
        							<div class="nws-button  text-capitalize">
                                        <button class="hover-btn" @click="handleCodeQr"> S'abonner</button>
                                    </div>
        						</div>
        					</div>
        					...
        					<div class=" wow fadeFromLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
        						<div class="s2-pricing_item card">
        							<div class="s2-pricing_price relative-position clearfix">
										...
										<div class="image" style="height: 100%; width: 100%;">
											<img src="../assets/site/img1.jpg" alt="" style="height: 100%; object-fit: cover;filter: brightness(75%); border-radius: 6px 6px 0 0;">
										</div>
        								<div class="s2-pricing_text">
        									<span>Basic</span>
        									<strong>80 000 F CFA</strong>
